...
//function normalizeCountry(myCountry) {
   ...
   //let normalisedCountry = {
      ...
      // avgIncome: countries.income.toFixed(2)
      // population: countries.population
      // lifeExpectancy: countries.lifeExpectancy.toFixed(2)
...
function normalizeCountries(countries) {
    return countries.map(normalizeCountry); // Use map to normalize each country
}
...
// southAsianCountries =
const southAsianCountries = normalizedCountries.filter(country => country.region === "South Asia");
